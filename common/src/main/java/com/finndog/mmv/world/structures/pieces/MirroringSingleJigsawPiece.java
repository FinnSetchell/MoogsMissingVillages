...
import com.finndog.mmv.mixins.structures.TemplateAccessor;
...
public class MirroringSingleJigsawPiece extends SinglePoolElement {
    ...
    public MirroringSingleJigsawPiece(SinglePoolElement singleJigsawPiece, Mirror mirror, Optional<LiquidSettings> liquidSettings) {
        this(((SinglePoolElementAccessor)singleJigsawPiece).ms_getTemplate(), ((SinglePoolElementAccessor)singleJigsawPiece).ms_getProcessors(), singleJigsawPiece.getProjection(), mirror, liquidSettings);
    }
    ...
    private ObjectArrayList<StructureTemplate.JigsawBlockInfo> getJigsaws(StructureTemplate template, BlockPos blockPos, StructurePlaceSettings structurePlaceSettings) {
        if (((TemplateAccessor)template).ms_getPalettes().isEmpty()) {
            return new ObjectArrayList<>();
        }
        else {
            List<StructureTemplate.JigsawBlockInfo> list = structurePlaceSettings.getRandomPalette(((TemplateAccessor)template).ms_getPalettes(), blockPos).jigsaws();
    ...
    public StructurePoolElementType<?> getType() {
        return MSStructurePieces.MIRROR_SINGLE.get();
    }
