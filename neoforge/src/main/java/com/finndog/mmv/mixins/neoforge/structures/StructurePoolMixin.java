package com.finndog.mmv.mixins.neoforge.structures;
...
public class StructurePoolMixin {
    ...
    private static Codec<Integer> ms_increaseWeightLimit(int minRange, int maxRange, Operation<Codec<Integer>> original) {
